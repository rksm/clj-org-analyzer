...
(defn help-view [close-help-fn]
  [:div.help-view
   ...
   time-tracking data (via org-clock-in). It parses org files and extracts
   CLOCK: timestamps. This is the underlying data displayed here."]

    [:h3 "Controls"]

    [:p "The app has four main panels:"
     [:ol
      [:li "search bar"
       [:p "foo"]]
      [:li "calendar"]]]
